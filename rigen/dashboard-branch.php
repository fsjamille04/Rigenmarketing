...
if ( !isset( $_SESSION['user_branch'] ) ) {
  header("Location: login-branch.php");
} 
$id_ses = $_SESSION['user_branch'];  
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="logout-btn">
            <a href="logout-branch.php" data-toggle="control-sidebar"><i class="fa fa-sign-out" aria-hidden="true"></i></a>
          </li>
        </ul>
      </div>
        ...
        <div class="col-md-12" >
            <form class="form-inline form_checkName"> 
              ...
              <button type="submit" style="padding: 10px"  class="btn btn-primary checkName">Search</button>
                ...
                <input type="text" style="padding: 20px"  class="form-control" id="inputcheck" placeholder="Code , Name or Phone number">
              </div>
            </form>   
          </div>
        <div class="col-md-8">
          <div class="box box-info">
            ...
            <div class="box-body">
                <div class="table-responsive"> 
                  <input type="hidden" name="id_ses" id="session" value="<?php echo $id_ses; ?>">
...
<script>
  $(document).ready(function(){
	...
	$('.logout-btn').click(function(){
        window.location.href = "logout-branch.php";
    });
    ...
    $('.form_checkName').submit(function(){
        ...
        $.ajax({
            ...
            datatype:'JSON',
            data:{
                action: "check_name_branch",
                val : val,
                id : id, 
            }, 
            success: function(data){   
                $('#loading').css("display","none"); 
                $('.append-table').html('<thead> <tr><th>#</th>  <th class="text-center">Name</th> <th class="text-center">Phone</th> <th class="text-center">Code</th> <th class="text-center">Date Encoded</th>   </tr> </thead> <tbody>' + data +  '</tbody> '); 
