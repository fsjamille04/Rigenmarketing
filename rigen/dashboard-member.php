    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12" >
            ...
            <!--    <input type="text" style="padding: 20px"  class="form-control" id="inputcheck" placeholder="Search Your Name or Phone Number">-->
            <!--  </div>-->
            <!--</form>   -->
          </div>
        <div class="col-md-8">
...
//                 }, 300000); 
  ...
  $(document).ready(function(){
	...
	$('.logout-btn').click(function(){
        window.location.href = "logout-member.php";
    });
    ...
    $('.form_checkName').submit(function(){
        ...
        $.ajax({
            ...
            success: function(data){   
                $('#loading').css("display","none"); 
                $('.append-table').html('<thead> <tr> <th>#</th> <th class="text-center">Name</th> <th class="text-center">Phone</th> <th class="text-center">Code</th> <th class="text-center">Date Incoded</th>  </tr> </thead> <tbody>' + data +  '</tbody> '); 
